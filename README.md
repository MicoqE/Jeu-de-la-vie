...
# Les règles
- si la cellule vis
    - si parmis les cellules autours 2 ou 3 sont en vie alors la cellules vie.
...
On vérifi l'était de chaque cellule autour de celle sur lequel le curseur sera et on sauvegard son état futur puis on fait de même avec la cellule suivante. à la fin on applique l'état suivant de toute les cellules puis on recommence le processuce.
